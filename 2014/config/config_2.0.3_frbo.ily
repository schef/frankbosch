...
\header {
  copyright = \markup { \override #'(font-name . "JohnSans White Pro") \override #'(font-size . -3) { Creative Commons Attribution-ShareAlike 4.0 | Udruga "Mjuzikids" Grigora Viteza 2, Zagreb, Hrvatska } }
